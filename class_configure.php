<?php
class laundry_configure
{
  public $ld_timezone;
  public $ld_country_code;
  public $conn;
  public $email;
  public $password;
  public $pc;
  ...
  {
    $this->ld_timezone = date_default_timezone_get();
  }
  /*Function for Read Only one data matched with Id*/

  public function q2()
  {
    $admin_info = "CREATE TABLE IF NOT EXISTS `ld_admin_info` (
  ...
  public function q3()
  {
    $bookings = "CREATE TABLE IF NOT EXISTS `ld_bookings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` bigint(20) NOT NULL,
  `client_id` bigint(20) NOT NULL,
  `order_date` date NOT NULL,
	
  `booking_delivery_date_time_start` datetime NOT NULL,
	`booking_delivery_date_time_end` datetime NOT NULL,
	`booking_pickup_date_time_start` datetime NOT NULL,
	`booking_pickup_date_time_end` datetime NOT NULL,
	`show_delivery_date` ENUM('E','D') NOT NULL DEFAULT 'D',
	`self_service` enum('Y','N') NOT NULL DEFAULT 'N',
  ...
  public function q4()
  {
    $booking_units = "CREATE TABLE IF NOT EXISTS `ld_booking_units` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` bigint(20) NOT NULL,
  ...
  PRIMARY KEY (`id`)
    ...
    mysqli_query($this->conn, $booking_units);
  }
  ...
  public function q5()
  {
    $coupons = "CREATE TABLE IF NOT EXISTS `ld_coupons` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  {
    $off_days = "
CREATE TABLE IF NOT EXISTS `ld_off_days` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  public function q8()
  {
    $order_client_info = "CREATE TABLE IF NOT EXISTS `ld_order_client_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
";
  ...
  public function q9()
  {
    $payments = "CREATE TABLE IF NOT EXISTS `ld_payments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11) NOT NULL,
  ...
  public function q10()
  {
    $schedule_breaks = "CREATE TABLE IF NOT EXISTS `ld_schedule_breaks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  public function q11()
  {
    $schedule_offtimes = "CREATE TABLE IF NOT EXISTS `ld_schedule_offtimes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `provider_id` int(11) NOT NULL,
  ...
  public function q12()
  {
    $services = "CREATE TABLE IF NOT EXISTS `ld_services` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
";
  ...
  public function q17()
  {
    $services_methods_units = "CREATE TABLE IF NOT EXISTS `ld_service_units` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `predefine_image` varchar(250) NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
";
    mysqli_query($this->conn, $services_methods_units);

    $services_methods_units_price = "CREATE TABLE IF NOT EXISTS `ld_service_units_price` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
	`service_id` int(11) NOT NULL,
	`service_unit_id` int(11) NOT NULL,
	`price` double NOT NULL,
	`article_status` enum('E','D') NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;";
    mysqli_query($this->conn, $services_methods_units_price);

    $ld_special_offer = "CREATE TABLE IF NOT EXISTS `ld_special_offer` (
      `id` int(11) NOT NULL AUTO_INCREMENT,
      `coupon_value` int(11) NOT NULL DEFAULT '0',
      `coupon_date` date NOT NULL,
      `coupon_type` enum('Y','N') NOT NULL,
      `special_text` varchar(50) NOT NULL,
       PRIMARY KEY (`id`)
      ) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;";
      mysqli_query($this->conn, $ld_special_offer);

  }
  public function q18()
  {
    $settings = "CREATE TABLE IF NOT EXISTS `ld_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  public function q19()
  {
    $users = "CREATE TABLE IF NOT EXISTS `ld_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
";
  ...
  {
    $week_days_available = "
CREATE TABLE IF NOT EXISTS `ld_week_days_available` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
";
  ...
  public function q21()
  {
    $languages = "CREATE TABLE IF NOT EXISTS `ld_languages` (
					  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  public function q23()
  {
    ...
    $regadmin = mysqli_query($this->conn, "select * from `ld_admin_info` where `id`=1");


    if (@mysqli_num_rows($regadmin) > 0) {

      $query1 = "Update `ld_admin_info` set `password`='" . $pass . "',`email`='" . $this->email . "'  where `id`=1";
      mysqli_query($this->conn, $query1);
      return '1';
    } else {
      $query1 = "INSERT INTO `ld_admin_info` (`id`, `password`, `email`, `fullname`, `phone`, `address`, `city`, `state`, `zip`, `country`,`role`, `description`, `enable_booking`, `service_commission`, `commision_value`, `schedule_type`, `image`, `service_ids`) VALUES (1, '" . $pass . "','" . $this->email . "' , '', '', '', '', '', '', '','admin', '', 'Y', 'F', '0', 'W', '', '');";
      mysqli_query($this->conn, $query1);
  ...
  public function q22()
  {
    ...
    $query3 = "INSERT INTO `ld_settings` (`id`, `option_name`, `option_value`,`postalcode`) VALUES
(1, 'ld_company_name', 'My Company Name',''),
(2, 'ld_company_email', 'companyemail@example.com',''),
(3, 'ld_company_address', 'SUITE 5A-1204, 799 E DRAGRAM',''),
(4, 'ld_company_city', 'TUCSON',''),
(5, 'ld_company_state', 'AZ',''),
(6, 'ld_company_zip_code', '85001',''),
(7, 'ld_company_country', 'USA',''),
(8, 'ld_company_logo', '',''),
(9, 'ld_time_interval', '30',''),
(10, 'ld_min_advance_booking_time', '60',''),
(11, 'ld_max_advance_booking_time', '6',''),
(12, 'ld_booking_padding_time', '',''),
(13, 'ld_service_padding_time_before', '',''),
(14, 'ld_service_padding_time_after', '',''),
(15, 'ld_cancellation_buffer_time', '60',''),
(16, 'ld_reshedule_buffer_time', '60',''),
(17, 'ld_currency', 'USD',''),
(18, 'ld_currency_symbol_position', '$100',''),
(19, 'ld_price_format_decimal_places', '2',''),
(20, 'ld_tax_vat_status', 'Y',''),
(21, 'ld_tax_vat_type', '',''),
(22, 'ld_tax_vat_value', '',''),
(23, 'ld_partial_deposit_status', 'N',''),
(24, 'ld_partial_deposit_amount', '50',''),
(25, 'ld_partial_deposit_message', 'You only need to pay a deposit to confirm your booking. The remaining amount needs to be paid on arrival.',''),
(26, 'ld_thankyou_page_url', '',''),
(27, 'ld_allow_multiple_booking_for_same_timeslot_status', 'Y',''),
(28, 'ld_appointment_auto_confirm_status', 'N',''),
(29, 'ld_allow_day_closing_time_overlap_booking', 'N',''),
(30, 'ld_allow_terms_and_conditions', 'Y',''),
(31, 'ld_primary_color', '#187d90',''),
(32, 'ld_secondary_color', '#49d6c3',''),
(33, 'ld_text_color', '#666666',''),
(34, 'ld_text_color_on_bg', '#ffffff',''),
(35, 'ld_primary_color_admin', '#187d90',''),
(36, 'ld_show_coupons_input_on_checkout', 'on',''),
(37, 'ld_hide_faded_already_booked_time_slots', 'off',''),
(38, 'ld_guest_user_checkout', 'off',''),
(39, 'ld_date_picker_date_format', 'd-M-Y',''),
(40, 'ld_all_payment_gateway_status', 'off',''),
(41, 'ld_pay_locally_status', 'on',''),
(42, 'ld_paypal_express_checkout_status', 'off',''),
(43, 'ld_paypal_api_username', '',''),
(44, 'ld_paypal_api_password', '',''),
(45, 'ld_paypal_api_signature', '',''),
(46, 'ld_paypal_guest_payment_status', 'off',''),
(47, 'ld_paypal_test_mode_status', 'off',''),
(48, 'ld_stripe_payment_form_status', 'off',''),
(49, 'ld_stripe_secretkey', '',''),
(50, 'ld_stripe_publishablekey', '',''),
(51, 'ld_admin_email_notification_status', 'N',''),
(52, 'ld_staff_email_notification_status', 'N',''),
(53, 'ld_client_email_notification_status', 'N',''),
(54, 'ld_email_sender_name', '',''),
(55, 'ld_email_sender_address', '',''),
(56, 'ld_email_appointment_reminder_buffer', '60',''),
(57, 'ld_sms_service_status', 'N',''),
(58, 'ld_sms_twilio_account_SID', '',''),
(59, 'ld_sms_twilio_auth_token', '',''),
(60, 'ld_sms_twilio_sender_number', '',''),
(61, 'ld_sms_twilio_send_sms_to_service_provider_status', 'N',''),
(62, 'ld_sms_twilio_send_sms_to_client_status', 'N',''),
(63, 'ld_sms_twilio_send_sms_to_admin_status', 'N',''),
(64, 'ld_sms_twilio_send_sms_to_staff_status', 'N',''),
(65, 'ld_sms_twilio_admin_phone_number', '',''),
(66, 'ld_sms_template_admin_notification', '',''),
(67, 'ld_sms_template_service_provider', '',''),
(68, 'ld_sms_template_client_notification', '',''),
(69, 'ld_time_slots_schedule_type', 'weekly',''),
(70, 'ld_choose_time_format', '12',''),
(71, 'ld_secondary_color_admin', '#49d6c3',''),
(72, 'ld_text_color_admin', '#ffffff',''),
(73, 'ld_postal_code', '','90001,90002,90003,90004,90005,90006,90007,90008,90009,90010,90011,90012,90013'),
(74, 'ld_time_format', '12',''),
(75, 'ld_partial_type', '',''),
(76, 'ld_cancelation_policy_status', 'N',''),
(77, 'ld_cancel_policy_header', 'Free cancellation before redemption',''),
(78, 'ld_cancel_policy_textarea', 'Full refund if cancelled within 24 hours of placing the order.\n\n\nIf you cancel the order more than 24 hours, you can get a credit note for the amount paid.\n\n\n\nIf cancelled in less than 24 hours before time of appointment/stay or in case of no-show, order will not be refunded.',''),
(79, 'ld_terms_condition_link', '',''),
(80, 'ld_addons_default_design', '2',''),
(81, 'ld_front_desc', '<div class=\"features\">\n	<img class=\"feature-img\" src=\"" . filter_var(SITE_URL, FILTER_VALIDATE_URL) . "/assets/images/icon21.png\" alt=\"\">\n	<h4 class=\"feature-tittle\">Safety</h4>\n	<p class=\"feature-text\">Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>\n</div>\n<div class=\"features\">\n	<img class=\"feature-img\" src=\"" . filter_var(SITE_URL, FILTER_VALIDATE_URL) . "/assets/images/icon31.png\" alt=\"\">\n	<h4 class=\"feature-tittle\">Best in Quality</h4>\n	<p class=\"feature-text\">Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>\n</div>\n<div class=\"features\">\n	<img class=\"feature-img\" src=\"" . filter_var(SITE_URL, FILTER_VALIDATE_URL) . "/assets/images/icon51.png\" alt=\"\">\n	<h4 class=\"feature-tittle\">Communication</h4>\n	<p class=\"feature-text\">Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>\n</div>\n<div class=\"features\">\n	<img class=\"feature-img\" src=\"" . filter_var(SITE_URL, FILTER_VALIDATE_URL) . "/assets/images/icon17.png\" alt=\"\">\n	<h4 class=\"feature-tittle\">Saves You Time</h4>\n	<p class=\"feature-text\">Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>\n</div>\n<div class=\"features\">\n	<img class=\"feature-img\" src=\"" . filter_var(SITE_URL, FILTER_VALIDATE_URL) . "/assets/images/icon61.png\" alt=\"\">\n	<h4 class=\"feature-tittle\">Card Payment</h4>\n	<p class=\"feature-text\"> Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>\n</div>',''),
(82, 'ld_subheaders', 'N',''),
(83, 'ld_cart_scrollable', 'Y',''),
(84, 'ld_service_default_design', '1',''),
(85, 'ld_privacy_policy_link', '',''),
(86, 'ld_allow_privacy_policy', 'Y',''),
(87, 'ld_allow_front_desc', 'Y',''),
(88, 'ld_currency_symbol', '$',''),
(89, 'ld_smtp_hostname', '',''),
(90, 'ld_smtp_username', '',''),
(91, 'ld_smtp_password', '',''),
(92, 'ld_smtp_port', '',''),
(93, 'ld_sample_data_status', 'N',''),
(94, 'ld_remove_data_array', '',''),
(95, 'ld_timezone', '" . $this->ld_timezone . "',''),
(96, 'ld_company_country_code', '+1,us,United States: +1',''),
(97, 'ld_language', 'en',''),
(98, 'ld_custom_css', '',''),
(99, 'ld_authorizenet_status', '',''),
(100, 'ld_authorizenet_API_login_ID', '',''),
(101, 'ld_authorizenet_transaction_key', '',''),
(102, 'ld_authorize_sandbox_mode', '',''),
(103, 'ld_version','1.1',''),
(104, 'ld_sms_plivo_account_SID', '',''),
(105, 'ld_sms_plivo_auth_token', '',''),
(106, 'ld_sms_plivo_sender_number', '',''),
(107, 'ld_sms_plivo_send_sms_to_service_provider_status', 'N',''),
(108, 'ld_sms_plivo_send_sms_to_client_status', 'N',''),
(109, 'ld_sms_plivo_send_sms_to_admin_status', 'N',''),
(110, 'ld_sms_plivo_send_sms_to_staff_status', 'N',''),
(111, 'ld_sms_plivo_admin_phone_number', '',''),
(114, 'ld_sms_twilio_status', 'N',''),
(115, 'ld_sms_plivo_status', 'N',''),
(116, 'ld_company_phone', '',''),
(117, 'ld_admin_optional_email', '',''),
(118, 'ld_2checkout_sandbox_mode', 'Y',''),
(119, 'ld_2checkout_privatekey', '',''),
(120, 'ld_2checkout_publishkey', '',''),
(121, 'ld_2checkout_sellerid', '',''),
(122, 'ld_2checkout_status', 'N',''),
(123, 'ld_postalcode_status', 'Y',''),
(124, 'ld_front_image', '',''),
(125, 'ld_login_image', '',''),
(126, 'ld_company_header_address', 'Y',''),
(127, 'ld_front_tool_tips_my_bookings','',''),
(128, 'ld_front_tool_tips_postal_code','',''),
(129, 'ld_front_tool_tips_services','',''),
(130, 'ld_front_tool_tips_addons_services','',''),
(131, 'ld_front_tool_tips_time_slots','',''),
(132, 'ld_front_tool_tips_personal_details','',''),
(133, 'ld_front_tool_tips_promocode','',''),
(134, 'ld_front_tool_payment_method','',''),
(135, 'ld_sms_nexmo_status','N',''),
(136, 'ld_nexmo_api_key','',''),
(137, 'ld_nexmo_api_secret','',''),
(138, 'ld_nexmo_from','',''),
(139, 'ld_nexmo_status','',''),
(140, 'ld_sms_nexmo_send_sms_to_client_status','N',''),
(141, 'ld_sms_nexmo_send_sms_to_admin_status','N',''),
(142, 'ld_sms_nexmo_send_sms_to_staff_status','N',''),
(143, 'ld_sms_nexmo_admin_phone_number','',''),
(144, 'ld_front_tool_tips_status','',''),
(145, 'ld_existing_and_new_user_checkout','on',''),
(146, 'ld_user_zip_code','Y',''),
(147, 'ld_payumoney_salt','',''),
(148, 'ld_payumoney_merchant_key','',''),
(149, 'ld_payumoney_status','N',''),
(150, 'ld_company_logo_display','N',''),
(151, 'ld_sms_textlocal_account_username','',''),
(152, 'ld_sms_textlocal_account_hash_id','',''),
(153, 'ld_sms_textlocal_send_sms_to_client_status','N',''),
(154, 'ld_sms_textlocal_send_sms_to_admin_status','N',''),
(155, 'ld_sms_textlocal_send_sms_to_staff_status','N',''),
(156, 'ld_sms_textlocal_admin_phone','',''),
(157, 'ld_sms_textlocal_status','N',''),
(158, 'ld_company_service_desc_status','Y',''),
(159, 'ld_company_willwe_getin_status','N',''),
(160, 'ld_bank_name','',''),
(161, 'ld_account_name','',''),
(162, 'ld_account_number','',''),
(163, 'ld_branch_code','',''),
(164, 'ld_ifsc_code','',''),
(165, 'ld_bank_transfer_status','N',''),
(166, 'ld_phone_display_country_code','',''),
(167, 'ld_bank_description','',''),
(168, 'ld_smtp_encryption','',''),
(169, 'ld_smtp_authetication','false',''),
(170, 'ld_bf_first_name','on,Y,3,15',''),
(171, 'ld_bf_last_name','on,Y,3,15',''),
(172, 'ld_bf_email','on,Y,5,30',''),
(173, 'ld_bf_password','on,Y,8,10',''),
(174, 'ld_bf_phone','on,Y,9,15',''),
(175, 'ld_bf_address','on,Y,10,40',''),
(176, 'ld_bf_zip_code','on,Y,5,7',''),
(177, 'ld_bf_city','on,Y,3,15',''),
(178, 'ld_bf_state','on,Y,3,15',''),
(179, 'ld_bf_notes','on,N,10,70',''),
(180, 'ld_front_language_selection_dropdown','Y',''),
(181, 'ld_calculation_policy','M',''),
(182, 'ld_favicon_image','fevicon.png',''),
(183, 'ld_loader','default',''),
(184, 'ld_page_title','Laundry Booking',''),
(185, 'ld_google_analytics_code','',''),
(186, 'ld_seo_meta_description','',''),
(187, 'ld_seo_og_title','',''),
(188, 'ld_seo_og_type','',''),
(189, 'ld_seo_og_url','',''),
(190, 'ld_seo_og_image','',''),
(191, 'ld_company_title_display','Y',''),
(192, 'ld_custom_gif_loader','',''),
(193, 'ld_custom_css_loader','',''),
(194, 'ld_calendar_defaultView','month',''),
(195, 'ld_calendar_firstDay','1',''),
(196, 'ld_gc_status','N',''),
(197, 'ld_gc_id','',''),
(198, 'ld_gc_client_id','',''),
(199, 'ld_gc_client_secret','',''),
(200, 'ld_gc_status_configure','',''),
(201, 'ld_gc_status_sync_configure','',''),
(202, 'ld_gc_token','',''),
(203, 'ld_gc_purchase_status','N',''),
(204, 'ld_gc_frontend_url','',''),
(205, 'ld_gc_version','',''),
(206, 'ld_gc_admin_url','',''),
(207, 'ld_payway_purchase_status','N',''),
(208, 'ld_payway_status','N',''),
(209, 'ld_payway_publishable_key','',''),
(210, 'ld_payway_secure_key','',''),
(211, 'ld_payway_version','',''),
(212, 'ld_payway_merchant_ID','',''),
(213, 'ld_eway_purchase_status','N',''),
(214, 'ld_eway_test_mode_status','N',''),
(215, 'ld_eway_api_username','',''),
(216, 'ld_eway_api_password','',''),
(217, 'ld_eway_status','N',''),
(218, 'ld_eway_version','',''),
(219, 'ld_payment_extensions','" . serialize(array('payway' => array('method' => 'indirect', 'include_path' => '/extension/payway/payway.php', 'option_name' => 'ld_payway_purchase_status'), 'eway' => array('method' => 'direct', 'include_path' => '/extension/eway/eway.php', 'option_name' => 'ld_eway_purchase_status'))) . "',''),
(220, 'ld_special_offer','N',''),
(221, 'ld_special_offer_text','',''),
(222, 'ld_star_show_on_front','N',''),
(223, 'ld_api_key','1',''),
(224, 'ld_minimum_delivery_days','2',''),
(225, 'ld_show_self_service','D',''),
(226, 'ld_show_delivery_date','E',''),
(227, 'ld_staff_registration', 'Y','');
";
    mysqli_query($this->conn, $query3);
    /* $ld_sms_templates2 = "ALTER TABLE `ld_sms_templates` CHANGE `id` `id` INT(11) NOT NULL AUTO_INCREMENT, CHANGE `sms_subject` `sms_subject` VARCHAR(200) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '', CHANGE `sms_message` `sms_message` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '', CHANGE `default_message` `default_message` TEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT '';";
        mysqli_query($this->conn,$ld_sms_templates2); */

    $ld_staff_commission2 = "ALTER TABLE `ld_staff_commission` CHANGE `id` `id` INT(11) NOT NULL AUTO_INCREMENT, CHANGE `order_id` `order_id` INT(11) NULL DEFAULT '0', CHANGE `staff_id` `staff_id` INT(11) NULL DEFAULT '0', CHANGE `amt_payable` `amt_payable` DOUBLE NULL DEFAULT '0', CHANGE `advance_paid` `advance_paid` DOUBLE NULL DEFAULT '0', CHANGE `net_total` `net_total` DOUBLE NULL DEFAULT '0', CHANGE `payment_method` `payment_method` VARCHAR(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '', CHANGE `transaction_id` `transaction_id` VARCHAR(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '';";
    mysqli_query($this->conn,$ld_staff_commission2);
  }
  public function q24()
  {
    $delete_schedule = "delete from ld_week_days_available";
    mysqli_query($this->conn, $delete_schedule);
    $insert_schedule = "INSERT INTO `ld_week_days_available` (`id`, `provider_id`, `week_id`, `weekday_id`, `day_start_time`, `day_end_time`, `off_day`, `provider_schedule_type`) VALUES
  ...
  public function q28()
  {
    $email_user = "CREATE TABLE IF NOT EXISTS `ld_email_user` (
        `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  public function q29()
  {
    $email_user = "CREATE TABLE IF NOT EXISTS `ld_sms_user` (
        `id` int(11) NOT NULL AUTO_INCREMENT,
        `cus_ids` text NOT NULL,
        `cus_msg` text NOT NULL,
        `cus_dt` TIMESTAMP,
  ...
  public function q0()
  {
    eval(base64_decode(''));
  }
  ...
  public function q25()
  {
    $errors = array(
      ...
      "please_select_units_or_addons" => urlencode("Please select units"),
      ...
      "your_cart_is_empty_please_add_laundry_services" => urlencode("Your cart is empty please add cleaning services"),
      "please_enter_coupon_code" => urlencode("Please enter Coupon code"),
      ...
      "maximum_advance_booking_time_is_over" => urlencode("Maximum Advance Booking Time is Over"),
      "please_select_atleast_one_checkout_method" => urlencode("Please select atleast one checkout method"),
      "appointment_booking_completed" => urlencode("Appointment booking completed"),
      "please_enter_hours" => urlencode("Please Enter Hours"),
      "please_enter_minutes" => urlencode("Please Enter Minutes"),
      "please_enter_minimum_5_minutes_maximum_59_minutes" => urlencode("Please Enter Minimum 5 Minutes Maximum 59 Minutes"),
      "invalid" => urlencode("Invalid"),
      "max_limit_reached" => urlencode("Max Limit Reached"),
      "please_enter_minlimit" => urlencode("Please Enter Minlimit"),
      "please_enter_value_greater_than_minlimit" => urlencode("Please Enter Value Greater Than Minlimit"),
      "you_can_set_area_of_laundry_minimum_limit_" => urlencode("You Can Set Area of Cleaning Minimum Limit "),

      "please_select_pickup_date" => urlencode("Please select Pickup Date "),
      "please_select_pickup_slot" => urlencode("Please select Pickup Slot "),
      "please_select_delivery_date" => urlencode("Please select Delivery Date "),
      "please_select_delivery_slot" => urlencode("Please select Delivery Slot "),
      "sorry_this_service_is_closed_now" => urlencode("Sorry this Service is Closed Now "),
    );
    ...
    $admin_labels = array(
      ...
      "its_your_laundry_booking_form_page_url" => urlencode("its your Laundry booking form page url"),
      "Its_your_laundry_Google_Settings_page_url" => urlencode("Its your Laundry Google Settings page url"),
      ...
      "login_page" => urlencode("Login Page"),
      "front_page" => urlencode("Front Page"),
      "before_e_g_100" => urlencode("Before(e.g.$100)"),
      "after_e_g_100" => urlencode("After(e.g.100$)"),
      ...
      "add_laundry_service" => urlencode("Add Cleaning Service"),
      ...
      "laundry_service" => urlencode("Cleaning Service"),
      ...
      "sender_email_address_laundry_admin_email" => urlencode("Sender Email"),
      ...
      "vaccum_laundry" => urlencode("Vaccum-Cleaner"),
      ...
      "choose_your_article_image" => urlencode("Choose your article image"),
      ...
      "vaccum_laundry_frontend_option_display_status" => urlencode("Vaccume Cleaner"),
      "o_n" => urlencode("On"),
      "off" => urlencode("Off"),
      ...
      "vaccum_laundry_status" => urlencode("vaccum_laundry_status"),
      ...
      "client_promocode" => urlencode("client_promocode"),
...
#2. You can use partial postal codes for wild card match entries,e.g. K1A,L2A,C3 ,system will match those starting letters of postal code on front and it will avoid you to write so many postal codes."),
      ...
      "cart_items" => urlencode("Cart Items"),
      ...
      "vaccume_laundry" => urlencode("Vaccume Cleaner"),
      "parking" => urlencode("Parking"),
      ...
      "ld_special_offer" => urlencode("Special Offer"),
      "ld_special_offer_text" => urlencode("Special offer Text"),
      "ld_staff_status_booking" => urlencode("Staff Status Of Booking"),
      "appointment_rescheduled_by_service_provider" => urlencode("Appointment Rescheduled by Service Provider"),
      "ld_staff_status" => urlencode("Staff Status "),
      "rating_and_review" => urlencode("Rating & Review"),
      "review" => urlencode("Review"),
      "show_frontend_staff_rating" => urlencode("Show Frontend Staff Rating"),
      "with_enable_of_this_feature_shows_staff_rating_on_front_side" => urlencode("With Enable of this feature, Shows staff rating on front side"),
      "complete_appointment" => urlencode("Complete Appointment"),
      "complete" => urlencode("Complete"),
      "display_time_duration_on_summary" => urlencode("Display Time Duration on Summary"),
      "reason" => urlencode("Reason"),
      "optional_label" => urlencode("Optional Label"),
      "optional_unit_symbol" => urlencode("Optional Unit Symbol"),
      "sqft" => urlencode("sq. ft."),
      "min_limit" => urlencode("Min Limit"),
      "send_sms_to_staff" => urlencode("Send SMS To Staff"),
      "staff_sms_template" => urlencode("Staff SMS Template"),
      "preview_template" => urlencode("Preview Template"),
      "client__promocode" => urlencode("client_promocode"),
      "staff__email" => urlencode("staff_email"),
      "staff__name" => urlencode("staff_name"),
      "enable_or_disable_send_sms_to_staff_for_appointment_booking_info" => urlencode("Enable or Disable, Send SMS to staff for appointment booking info."),

      "articles" => urlencode("Articles"),
      "article_image" => urlencode("Article Image"),
      "booking_article" => urlencode("Booking Article"),
      "article_name" => urlencode("Article Name"),
      "article_rate" => urlencode("Article Rate"),
      "article_quantity" => urlencode("Article Quantity"),
      "minimum_limit" => urlencode("Minimum Limit"),
      "maximum_limit" => urlencode("Maximum Limit"),
      "service_article" => urlencode("Service Article"),
      "minimum_delivery_days" => urlencode(" Minimum Delivery Days"),
      "advance_booking_days_limit" => urlencode(" Advance Booking Days Limit"),
      "maximum_order_per_day" => urlencode("Maximum Order Per Day"),
      "show_self_service_option" => urlencode("Show Self Service Option"),
      "show_delivery_date" => urlencode("Show Delivery Date"),
    );
    ...
    $front_labels = array(
      ...
      "city_placeholder" => urlencode("e.g. Los Angeles"),
      "state_placeholder" => urlencode("e.g. CA"),
      ...
      "how_often_would_you_like_us_provide_service" => urlencode("How often would you like us to provide service?"),
      ...
      "do_you_have_a_vaccum_laundry" => urlencode("Do you have a vacuum cleaner?"),
      ...
      "recurring_discounts_apply_from_the_second_laundry_onward" => urlencode("Recurring discounts apply from the second cleaning onward."),
      ...
      "please_configure_first_laundry_services_and_settings_in_admin_panel" => urlencode("Please configure first Cleaning Services and settings in admin panel"),
      ...
      "your" => urlencode("Your"),
      "your_laundry_items" => urlencode("Your clean items"),
      "cart_is_empty" => urlencode("Cart is empty"),
      ...
      "carpet_laundry" => urlencode("Carpet Cleaning"),
      "green_laundry" => urlencode("Green Cleaning"),
      "pets_care" => urlencode("Pets Care"),
      "tiles_laundry" => urlencode("Tiles Cleaning"),
      "wall_laundry" => urlencode("Wall Cleaning"),
      "laundry" => urlencode("Laundry"),
      "basement_laundry" => urlencode("Basement Cleaning"),
      ...
      "for_initial_laundry_only_contact_us_to_apply_to_recurrings" => urlencode("For initial cleaning only. Contact us to apply to recurrings."),
      ...
      "select_pick_up_date_and_time" => urlencode("Select Pick-up Date & Time"),
      "select_delivery_date_and_time" => urlencode("Select Delivery Date & Time"),
      "self_service" => urlencode("Self Service"),
      "when_would_you_like_us_to_pickup_and_deliver_your_clothes?" => urlencode("When would you like us to pickup and deliver your clothes?"),
      "pickup" => urlencode("Pickup"),
      "delivery" => urlencode("Delivery"),
      "select_articles" => urlencode("Select Articles"),
      "express_booking_price" => urlencode("Express Booking Price"),
      "on" => urlencode("Enable"),
      "off" => urlencode("Disable")
    );
    ...
    $delete_default_lang = "TRUNCATE TABLE  `ld_languages`;";
    mysqli_query($this->conn, $delete_default_lang);

    $insert_default_lang = "insert into `ld_languages` (`id`,`label_data`,`language`, `admin_labels`, `error_labels`, `extra_labels`, `front_error_labels`,`language_status`) values(NULL,'" . $language_front_arr . "','en','" . $language_admin_arr . "','" . $language_error_arr . "','" . $language_extra_arr . "','" . $language_form_error_arr . "','Y')";
    ...
    $label_data_de_DE = array(
      ...
      "state_placeholder" => urlencode("z.B. CA"),
      "payumoney" => urlencode("PayUmoney"),
      ...
      "how_often_would_you_like_us_provide_service" => urlencode("Hoe vaak wilt u dat wij service verlenen?"),
      ...
      "laundry_service" => urlencode("Reinigungsservice"),
      ...
      "do_you_have_a_vaccum_laundry" => urlencode("Hast du einen Staubsauger?"),
      ...
      "recurring_discounts_apply_from_the_second_laundry_onward" => urlencode("Wiederkehrende Rabatte gelten ab der zweiten Reinigung."),
      ...
      "please_configure_first_laundry_services_and_settings_in_admin_panel" => urlencode(" Bitte konfigurieren Sie die ersten Reinigungsdienste und Einstellungen im Admin-Panel"),
      ...
      "your" => urlencode("Ihre"),
      "your_laundry_items" => urlencode("Deine sauberen Gegenstände"),
      "cart_is_empty" => urlencode("Winkelwagen is leeg"),
      "sub_totaltax" => urlencode(" Sub TotalTax"),
      ...
      "carpet_laundry" => urlencode("Teppichreinigung"),
      "green_laundry" => urlencode("Grüne Reinigung"),
      "pets_care" => urlencode("Haustiere Pflege"),
      "tiles_laundry" => urlencode("Fliesen Reinigung"),
      "wall_laundry" => urlencode("Wandreinigung"),
      "laundry" => urlencode("Wäsche"),
      "basement_laundry" => urlencode("Kellerreinigung"),
      ...
      "for_initial_laundry_only_contact_us_to_apply_to_recurrings" => urlencode(" Nur zur anfänglichen Reinigung. Kontaktieren Sie uns, um die Rekursion zu beantragen."),
      ...
      "duration" => urlencode("Looptijd"),

      "select_pick_up_date_and_time" => urlencode("Selecteer Ophaaldatum en -tijd"),
      "select_delivery_date_and_time" => urlencode("Selecteer bezorgdatum en -tijd"),
      "self_service" => urlencode("Zelfbediening"),
      "when_would_you_like_us_to_pickup_and_deliver_your_clothes?" => urlencode("Wanneer wilt u dat wij uw kleding ophalen en afleveren?"),
      "pickup" => urlencode("Oppakken"),
      "delivery" => urlencode("Levering"),
      "select_articles" => urlencode("Selecteer artikelen"),
    );
    ...
    $admin_labels_de_DE = array(
      ...
      "its_your_laundry_booking_form_page_url" => urlencode(" es ist Ihre Laundry Buchungsformular Seite URL"),
      "Its_your_laundry_Google_Settings_page_url" => urlencode("Es ist Ihre Laundry Google Einstellungen Seite URL"),
      ...
      "add_laundry_service" => urlencode("Reinigungsservice hinzufügen"),
      ...
      "send_mail" => urlencode(" E-Mail senden"),
      "sender_email_address_laundry_admin_email" => urlencode("Absender E-Mail"),
      ...
      "vaccum_laundry" => urlencode("Staubsauger"),
      ...
      "choose_your_article_image" => urlencode("Kies uw artikelafbeelding"),
      ...
      "client_email" => urlencode("client_email"),
      "vaccum_laundry_status" => urlencode("vakuum_cleaner_status"),
      ...
      "cart_items" => urlencode("Winkelwagen Items"),
      ...
      "vaccume_laundry" => urlencode("Staubsauger"),
      ...
      "ld_special_offer" => urlencode("Sonderangebot"),
      "ld_special_offer_text" => urlencode("Sonderangebot Text"),
      "appointment_rescheduled_by_service_provider" => urlencode("Afspraak opnieuw gepland door serviceprovider"),
      "rating_and_review" => urlencode("Beoordeling en beoordeling"),
      "review" => urlencode("beoordeling"),
      "show_frontend_staff_rating" => urlencode("Toon personeelsleden van Frontend"),
      "with_enable_of_this_feature_shows_staff_rating_on_front_side" => urlencode("Met de functie Inschakelen van deze functie, wordt de personeelsclassificatie op de voorkant getoond"),
      "complete_appointment" => urlencode("Afspraak maken"),
      "complete" => urlencode("Compleet"),
      "display_time_duration_on_summary" => urlencode("Weergaveduur Duur op samenvatting"),
      "reason" => urlencode("Reden"),
      "optional_label" => urlencode("Optioneel label"),
      "optional_unit_symbol" => urlencode("Optioneel eenheidsymbool"),
      "sqft" => urlencode("sq. ft."),
      "min_limit" => urlencode("Mijn limiet"),
      "send_sms_to_staff" => urlencode("Stuur een SMS naar het personeel"),
      "staff_sms_template" => urlencode("SMS-sjabloon personeel"),
      "preview_template" => urlencode("Voorbeeldsjabloon"),
      "client__promocode" => urlencode("client_promocode"),
      "staff__email" => urlencode("staff_email"),
      "staff__name" => urlencode("staff_name"),
      "enable_or_disable_send_sms_to_staff_for_appointment_booking_info" => urlencode("Inschakelen of Uitschakelen, Stuur SMS naar personeel voor afspraak boekingsinformatie."),
      "articles" => urlencode("artikelen"),
      "article_image" => urlencode("Artikel afbeelding"),
      "booking_article" => urlencode("Artikel boeken"),
      "article_name" => urlencode("Artikel naam"),
      "article_rate" => urlencode("Article Rate"),
      "article_quantity" => urlencode("Artikel hoeveelheid"),
      "minimum_limit" => urlencode("Minimum limiet"),
      "maximum_limit" => urlencode("Maximale limiet"),
      "service_article" => urlencode("Service artikel"),
      "minimum_delivery_days" => urlencode(" Minimale leveringsdagen"),
      "advance_booking_days_limit" => urlencode("Advance Booking Days Limit"),
      "maximum_order_per_day" => urlencode("Maximale bestelling per dag"),
      "show_self_service_option" => urlencode("Toon Self Service Option"),
      "show_delivery_date" => urlencode("Toon leverdatum"),
    );
    ...
    $error_labels_de_DE = array(
      ...
      "your_cart_is_empty_please_add_laundry_services" => urlencode("Ihr Warenkorb ist leer. Bitte Reinigungsservice hinzufügen"),
      ...
      "maximum_advance_booking_time_is_over" => urlencode("Maximale Advance-boekingstijd is voorbij"),
      "appointment_booking_completed" => urlencode("Afspraak boeking voltooid"),
      "please_enter_hours" => urlencode("Voer uren in"),
      "please_enter_minutes" => urlencode("Voer alstublieft minuten in"),
      "please_enter_minimum_5_minutes_maximum_59_minutes" => urlencode("Voer minimaal 5 minuten en maximaal 59 minuten in"),
      "invalid" => urlencode("Ongeldig"),
      "max_limit_reached" => urlencode("Max. Limiet bereikt"),
      "please_enter_minlimit" => urlencode("Voer alstublieft Minlimit in"),
      "please_enter_value_greater_than_minlimit" => urlencode("Voer een waarde in die groter is dan minimiet"),
      "you_can_set_area_of_laundry_minimum_limit_" => urlencode("U kunt de minimale minimumlimiet voor reiniging instellen "),


      "please_select_pickup_date" => urlencode("Selecteer ophaaldatum "),
      "please_select_pickup_slot" => urlencode("Selecteer Pickup Slot "),
      "please_select_delivery_date" => urlencode("Selecteer de leverdatum "),
      "please_select_delivery_slot" => urlencode("Selecteer Delivery Slot "),
      "sorry_this_service_is_closed_now" => urlencode("Sorry, deze dienst is nu gesloten"),
    );
    ...
    $insert_default_lang_de_DE = "insert into `ld_languages` (`id`,`label_data`,`language`, `admin_labels`, `error_labels`, `extra_labels`, `front_error_labels`,`language_status`) values(NULL,'" . $language_front_arr_de_DE . "','de_DE','" . $language_admin_arr_de_DE . "','" . $language_error_arr_de_DE . "','" . $language_extra_arr_de_DE . "','" . $language_form_error_arr_de_DE . "','Y')";
    ...
    $label_data_es_ES = array(
      ...
      "how_often_would_you_like_us_provide_service" => urlencode("Con qué frecuencia le gustaría que le brindemos un servicio?"),
      ...
      "laundry_service" => urlencode("Servicio de limpieza"),
      ...
      "do_you_have_a_vaccum_laundry" => urlencode("¿Tienes una aspiradora?"),
      ...
      "recurring_discounts_apply_from_the_second_laundry_onward" => urlencode("Los descuentos recurrentes se aplican desde la segunda limpieza en adelante."),
      ...
      "please_configure_first_laundry_services_and_settings_in_admin_panel" => urlencode("Configure primero los Servicios de limpieza y la configuración en el panel de administración"),
      ...
      "your" => urlencode("Tu"),
      "your_laundry_items" => urlencode("Tus artículos limpios"),
      "cart_is_empty" => urlencode("El carrito esta vacío"),
      "sub_totaltax" => urlencode("Sub TotalTax"),
      "sub_total" => urlencode("Sub Total"),
      ...
      "carpet_laundry" => urlencode("Limpieza de alfombra"),
      "green_laundry" => urlencode("Limpieza verde"),
      "pets_care" => urlencode("Cuidado de mascotas"),
      "tiles_laundry" => urlencode("Azulejos de limpieza"),
      "wall_laundry" => urlencode("Limpieza de paredes"),
      "laundry" => urlencode("Lavandería"),
      "basement_laundry" => urlencode("Limpieza del sótano"),
      ...
      "for_initial_laundry_only_contact_us_to_apply_to_recurrings" => urlencode("Para limpieza inicial solamente. Póngase en contacto con nosotros para solicitar recurrencias."),
      ...
      "duration" => urlencode("Duración"),


      "select_pick_up_date_and_time" => urlencode("Seleccione la fecha y hora de recogida"),
      "select_delivery_date_and_time" => urlencode("Seleccione la fecha y hora de entrega"),
      "self_service" => urlencode("Autoservicio"),
      "when_would_you_like_us_to_pickup_and_deliver_your_clothes?" => urlencode("¿Cuándo quieres que recojamos y entreguemos tu ropa?"),
      "pickup" => urlencode("Recoger"),
      "delivery" => urlencode("Entrega"),
      "select_articles" => urlencode("Seleccionar articulos"),
    );
    ...
    $admin_labels_es_ES = array(
      ...
      "its_your_laundry_booking_form_page_url" => urlencode("es tu URL de página de formulario de reserva de Laundry"),
      "Its_your_laundry_Google_Settings_page_url" => urlencode("Es su url de la página de configuración de Google Laundry"),
      ...
      "add_laundry_service" => urlencode("Añadir servicio de limpieza"),
      ...
      "send_mail" => urlencode("Enviar correo"),
      "sender_email_address_laundry_admin_email" => urlencode("Correo electrónico del remitente"),
      ...
      "vaccum_laundry" => urlencode("Aspiradora"),
      ...
      "choose_your_article_image" => urlencode("
Elige la imagen de tu artículo"),
      "addon_image" => urlencode("Addon Image"),
      ...
      "vaccum_laundry_frontend_option_display_status" => urlencode("Aspiradora"),
      "o_n" => urlencode("En"),
      ...
      "cart_items" => urlencode("Artículos del carrito"),
      ...
      "vaccume_laundry" => urlencode("Aspiradora"),
      ...
      "ld_special_offer" => urlencode("Oferta especial"),
      "ld_special_offer_text" => urlencode("Texto de oferta especial"),
      "appointment_rescheduled_by_service_provider" => urlencode("Cita reprogramada por el proveedor de servicios"),
      "rating_and_review" => urlencode("Calificación y revisión"),
      "review" => urlencode("Revisión"),
      "show_frontend_staff_rating" => urlencode("Mostrar Clasificación de Personal de Frontend"),
      "with_enable_of_this_feature_shows_staff_rating_on_front_side" => urlencode("Con la habilitación de esta función, muestra la calificación del personal en la parte frontal"),
      "complete_appointment" => urlencode("Cita completa"),
      "complete" => urlencode("Completar"),
      "display_time_duration_on_summary" => urlencode("Mostrar la duración del tiempo en el resumen"),
      "reason" => urlencode("Razón"),
      "optional_label" => urlencode("Etiqueta opcional"),
      "optional_unit_symbol" => urlencode("Símbolo de unidad opcional"),
      "sqft" => urlencode("pies cuadrados"),
      "min_limit" => urlencode("Mi limite"),
      "send_sms_to_staff" => urlencode("Enviar SMS al personal"),
      "staff_sms_template" => urlencode("Plantilla SMS para el personal"),
      "preview_template" => urlencode("Plantilla de vista previa"),
      "client__promocode" => urlencode("client_promocode"),
      "staff__email" => urlencode("staff_email"),
      "staff__name" => urlencode("Nombre del personal"),
      "enable_or_disable_send_sms_to_staff_for_appointment_booking_info" => urlencode("Habilitar o deshabilitar, enviar SMS al personal para obtener información de reserva de cita."),


      "articles" => urlencode("Artículos"),
      "article_image" => urlencode("Imagen del artículo"),
      "booking_article" => urlencode("Artículo de reserva"),
      "article_name" => urlencode("Nombre del artículo"),
      "article_rate" => urlencode("Tasa de artículo"),
      "article_quantity" => urlencode("Cantidad de artículos"),
      "minimum_limit" => urlencode("Limite minimo"),
      "maximum_limit" => urlencode("Límite máximo"),
      "service_article" => urlencode("Artículo de servicio"),
      "minimum_delivery_days" => urlencode(" Días de entrega mínimos"),
      "advance_booking_days_limit" => urlencode(" Límite de días de reserva anticipada"),
      "maximum_order_per_day" => urlencode("Orden Máxima Por Día"),
      "show_self_service_option" => urlencode("Mostrar opción de autoservicio"),
      "show_delivery_date" => urlencode("Mostrar fecha de entrega"),
    );
    ...
    $error_labels_es_ES = array(
      ...
      "your_cart_is_empty_please_add_laundry_services" => urlencode("Su carrito está vacío, agregue servicios de limpieza"),
      ...
      "maximum_advance_booking_time_is_over" => urlencode("El tiempo máximo de reserva anticipada ha terminado"),
      "appointment_booking_completed" => urlencode("Reserva de cita completada"),
      "please_enter_hours" => urlencode("Por favor ingrese las horas"),
      "please_enter_minutes" => urlencode("Por favor ingrese los minutos"),
      "please_enter_minimum_5_minutes_maximum_59_minutes" => urlencode("Por favor ingrese un mínimo de 5 minutos Máximo de 59 minutos"),
      "invalid" => urlencode("Inválido"),
      "max_limit_reached" => urlencode("Límite máximo alcanzado"),
      "please_enter_minlimit" => urlencode("Por favor ingrese minlimit"),
      "please_enter_value_greater_than_minlimit" => urlencode("Por favor ingrese un valor mayor que minlimit"),
      "you_can_set_area_of_laundry_minimum_limit_" => urlencode("Puede configurar el área de limpieza límite mínimo "),


      "please_select_pickup_date" => urlencode("Por favor seleccione la fecha de recogida "),
      "please_select_pickup_slot" => urlencode("Por favor, seleccione la ranura de recogida"),
      "please_select_delivery_date" => urlencode("Por favor seleccione la fecha de entrega "),
      "please_select_delivery_slot" => urlencode("Por favor seleccione Delivery Slot "),
      "sorry_this_service_is_closed_now" => urlencode("Lo sentimos, este servicio está cerrado ahora "),
    );
    ...
    $insert_default_lang_es_ES = "insert into `ld_languages` (`id`,`label_data`,`language`, `admin_labels`, `error_labels`, `extra_labels`, `front_error_labels`,`language_status`) values(NULL,'" . $language_front_arr_es_ES . "','es_ES','" . $language_admin_arr_es_ES . "','" . $language_error_arr_es_ES . "','" . $language_extra_arr_es_ES . "','" . $language_form_error_arr_es_ES . "','Y')";
    ...
    $label_data_fr_FR = array(
      ...
      "how_often_would_you_like_us_provide_service" => urlencode("À quelle fréquence aimeriez-vous que nous fournissions un service?"),
      ...
      "laundry_service" => urlencode(" Service de nettoyage"),
      ...
      "do_you_have_a_vaccum_laundry" => urlencode(" Avez-vous un aspirateur?"),
      ...
      "recurring_discounts_apply_from_the_second_laundry_onward" => urlencode(" Des réductions récurrentes s'appliquent dès le deuxième nettoyage."),
      ...
      "please_configure_first_laundry_services_and_settings_in_admin_panel" => urlencode("Veuillez configurer d'abord les services de nettoyage et les paramètres dans le panneau d'administration"),
      ...
      "your_laundry_items" => urlencode(" Vos articles propres"),
      "cart_is_empty" => urlencode("Le panier est vide"),
      ...
      "carpet_laundry" => urlencode(" Nettoyage de tapis"),
      "green_laundry" => urlencode(" Nettoyage vert"),
      "pets_care" => urlencode(" Animaux de compagnie"),
      "tiles_laundry" => urlencode("Nettoyage de carreaux"),
      "wall_laundry" => urlencode("Nettoyage des murs"),
      "laundry" => urlencode("Blanchisserie"),
      "basement_laundry" => urlencode(" Nettoyage de sous-sol"),
      ...
      "for_initial_laundry_only_contact_us_to_apply_to_recurrings" => urlencode(" Pour le nettoyage initial seulement. Contactez-nous pour postuler aux récurrences."),
      ...
      "duration" => urlencode("Durée"),


      "select_pick_up_date_and_time" => urlencode("Sélectionnez la date et l'heure de l'enlèvement"),
      "select_delivery_date_and_time" => urlencode("Sélectionnez la date et l'heure de livraison"),
      "self_service" => urlencode("En libre service"),
      "when_would_you_like_us_to_pickup_and_deliver_your_clothes?" => urlencode("Quand voudriez-vous que nous récupérions et livrions vos vêtements??"),
      "pickup" => urlencode("Ramasser"),
      "delivery" => urlencode("Livraison"),
      "select_articles" => urlencode("Sélectionner des articles"),
    );
    ...
    $admin_labels_fr_FR = array(
      ...
      "its_your_laundry_booking_form_page_url" => urlencode(" sa page de formulaire de réservation Laundry urlits votre page de formulaire de réservation Laundry url"),
      "Its_your_laundry_Google_Settings_page_url" => urlencode("C'est l'URL de votre page "),
      ...
      "add_laundry_service" => urlencode("Ajouter un service de nettoyage"),
      ...
      "send_mail" => urlencode("Envoyer un mail"),
      "sender_email_address_laundry_admin_email" => urlencode("Email de l'expéditeur"),
      ...
      "vaccum_laundry" => urlencode(" Aspirateur"),
      ...
      "choose_your_article_image" => urlencode("Choisissez votre image de l'article"),
      ...
      "parking_availability_frontend_option_display_status" => urlencode(" Parking"),
      "vaccum_laundry_frontend_option_display_status" => urlencode(" Aspirateur"),
      "o_n" => urlencode(" Sur"),
      "off" => urlencode("De"),
      ...
      "cart_items" => urlencode("Articles du panier"),
      ...
      "vaccume_laundry" => urlencode(" Aspirateur"),
      ...
      "ld_special_offer" => urlencode(" Offre spéciale"),
      "ld_special_offer_text" => urlencode(" Offre spéciale Texte"),
      "appointment_rescheduled_by_service_provider" => urlencode("Rendez-vous reporté par le fournisseur de services"),
      "rating_and_review" => urlencode("Notation et révision"),
      "review" => urlencode("La revue"),
      "show_frontend_staff_rating" => urlencode("Afficher les notes du personnel"),
      "with_enable_of_this_feature_shows_staff_rating_on_front_side" => urlencode("Avec l’activation de cette fonctionnalité, affiche l’évaluation du personnel sur le recto"),
      "complete_appointment" => urlencode("Rendez-vous complet"),
      "complete" => urlencode("Achevée"),
      "display_time_duration_on_summary" => urlencode("Durée d'affichage sur le résumé"),
      "reason" => urlencode("Raison"),
      "optional_label" => urlencode("Étiquette facultative"),
      "optional_unit_symbol" => urlencode("Symbole d'unité en option"),
      "sqft" => urlencode("pi2"),
      "min_limit" => urlencode("Ma limite"),
      "send_sms_to_staff" => urlencode("Envoyer un SMS au personnel"),
      "staff_sms_template" => urlencode("Modèle SMS du personnel"),
      "preview_template" => urlencode("Modèle de prévisualisation"),
      "client__promocode" => urlencode("client_promocode"),
      "staff__email" => urlencode("staff_email"),
      "staff__name" => urlencode("staff_name"),
      "enable_or_disable_send_sms_to_staff_for_appointment_booking_info" => urlencode("Activer ou désactiver, envoyer un SMS au personnel pour obtenir des informations sur la réservation d'un rendez-vous."),


      "articles" => urlencode("Des articles"),
      "article_image" => urlencode("Image de l'article"),
      "booking_article" => urlencode("Article de réservation"),
      "article_name" => urlencode("Nom d'article"),
      "article_rate" => urlencode("Taux de l'article"),
      "article_quantity" => urlencode("Quantité d'article"),
      "minimum_limit" => urlencode("Limite minimale"),
      "maximum_limit" => urlencode("Limite maximale"),
      "service_article" => urlencode("Article de service"),
      "minimum_delivery_days" => urlencode(" Jours de livraison minimum"),
      "advance_booking_days_limit" => urlencode(" Nombre de jours réservés à l'avance"),
      "maximum_order_per_day" => urlencode("Commande maximum par jour"),
      "show_self_service_option" => urlencode("Afficher l'option de libre service"),
      "show_delivery_date" => urlencode("Afficher la date de livraison"),
    );
    ...
    $error_labels_fr_FR = array(
      ...
      "your_cart_is_empty_please_add_laundry_services" => urlencode(" Votre panier est vide s'il vous plaît ajouter des services de nettoyage"),
      ...
      "maximum_advance_booking_time_is_over" => urlencode("Le délai maximum de réservation à l'avance est écoulé"),
      "appointment_booking_completed" => urlencode("Rendez-vous terminé"),
      "please_enter_hours" => urlencode("S'il vous plaît entrer les heures"),
      "please_enter_minutes" => urlencode("Veuillez entrer les minutes"),
      "please_enter_minimum_5_minutes_maximum_59_minutes" => urlencode("S'il vous plaît entrer minimum 5 minutes maximum 59 minutes"),
      "invalid" => urlencode("Invalide"),
      "max_limit_reached" => urlencode("Limite maximale atteinte"),
      "please_enter_minlimit" => urlencode("S'il vous plaît entrer minlimit"),
      "please_enter_value_greater_than_minlimit" => urlencode("Veuillez entrer une valeur supérieure à minlimit"),
      "you_can_set_area_of_laundry_minimum_limit_" => urlencode("Vous pouvez définir une zone de nettoyage minimum limite "),


      "please_select_pickup_date" => urlencode("Veuillez sélectionner la date de prise en charge "),
      "please_select_pickup_slot" => urlencode("Veuillez sélectionner l'emplacement de ramassage "),
      "please_select_delivery_date" => urlencode("Veuillez sélectionner la date de livraison "),
      "please_select_delivery_slot" => urlencode("Veuillez sélectionner l'emplacement de livraison"),
      "sorry_this_service_is_closed_now" => urlencode("Désolé, ce service est fermé maintenant "),
    );
    ...
    $insert_default_lang_fr_FR = "insert into `ld_languages` (`id`,`label_data`,`language`, `admin_labels`, `error_labels`, `extra_labels`, `front_error_labels`,`language_status`) values(NULL,'" . $language_front_arr_fr_FR . "','fr_FR','" . $language_admin_arr_fr_FR . "','" . $language_error_arr_fr_FR . "','" . $language_extra_arr_fr_FR . "','" . $language_form_error_arr_fr_FR . "','Y')";
    ...
    $label_data_pt_PT = array(
      ...
      "how_often_would_you_like_us_provide_service" => urlencode("Com que frequência você gostaria que prestássemos serviço?"),
      ...
      "laundry_service" => urlencode("Serviço de limpeza"),
      ...
      "do_you_have_a_vaccum_laundry" => urlencode("Você tem um aspirador de pó?"),
      ...
      "recurring_discounts_apply_from_the_second_laundry_onward" => urlencode("Descontos recorrentes se aplicam a partir da segunda limpeza."),
      ...
      "please_configure_first_laundry_services_and_settings_in_admin_panel" => urlencode("Por favor, configure os primeiros serviços de limpeza e configurações no painel de administração"),
      ...
      "your" => urlencode("Seu"),
      "your_laundry_items" => urlencode("Seus itens limpos"),
      "cart_is_empty" => urlencode("carrinho esta vazio"),
      ...
      "carpet_laundry" => urlencode("Limpeza de carpete"),
      "green_laundry" => urlencode("Limpeza Verde"),
      "pets_care" => urlencode("Cuidado De Animais De Estimação"),
      "tiles_laundry" => urlencode("Limpeza de Azulejos"),
      "wall_laundry" => urlencode("Limpeza de paredes"),
      "laundry" => urlencode("Lavanderia"),
      "basement_laundry" => urlencode("Limpeza De Porão"),
      ...
      "for_initial_laundry_only_contact_us_to_apply_to_recurrings" => urlencode("Apenas para limpeza inicial. Entre em contato conosco para se candidatar a reincidências."),
      "number_of" => urlencode("Número de"),
      ...
      "duration" => urlencode("Duração"),


      "select_pick_up_date_and_time" => urlencode("Selecione Data e Hora de Entrega"),
      "select_delivery_date_and_time" => urlencode("Selecione Data e Hora de Entrega"),
      "self_service" => urlencode("Self-service"),
      "when_would_you_like_us_to_pickup_and_deliver_your_clothes?" => urlencode("Quando você gostaria que nós pegássemos e entregássemos suas roupas?"),
      "pickup" => urlencode("Pegar"),
      "delivery" => urlencode("Entrega"),
      "select_articles" => urlencode("Selecione Artigos"),
    );
    ...
    $admin_labels_pt_PT = array(
      ...
      "its_your_laundry_booking_form_page_url" => urlencode("é o seu URL de página de formulário de reserva Laundry"),
      "Its_your_laundry_Google_Settings_page_url" => urlencode("É o seu URL da página de configurações do Google Laundry"),
      ...
      "add_laundry_service" => urlencode("Adicionar serviço de limpeza"),
      ...
      "sender_email_address_laundry_admin_email" => urlencode("E-mail do remetente"),
      "sender_name" => urlencode("Sender Name"),
      ...
      "vaccum_laundry" => urlencode("Aspirador de pó"),
      ...
      "choose_your_article_image" => urlencode("Escolha a imagem do seu artigo"),
      "addon_image" => urlencode("Addon Image"),
      ...
      "vaccum_laundry_frontend_option_display_status" => urlencode("Aspirador de pó"),
      "o_n" => urlencode("Em"),
      "off" => urlencode("Fora"),
      "enable" => urlencode("Habilitar"),
      ...
      "cart_items" => urlencode("Itens do carrinho"),
      ...
      "vaccume_laundry" => urlencode("Aspirador de pó"),
      ...
      "ld_special_offer" => urlencode("Oferta especial"),
      "ld_special_offer_text" => urlencode("Oferta especial Texto"),
      "appointment_rescheduled_by_service_provider" => urlencode("Nomeação reprogramada pelo provedor de serviços"),
      "rating_and_review" => urlencode("Avaliação e Revisão"),
      "review" => urlencode("Reveja"),
      "show_frontend_staff_rating" => urlencode("Mostrar Classificação do Pessoal Frontend"),
      "with_enable_of_this_feature_shows_staff_rating_on_front_side" => urlencode("Com a opção Habilitar este recurso, mostra a classificação da equipe na frente"),
      "complete_appointment" => urlencode("Compromisso completo"),
      "complete" => urlencode("Completo"),
      "display_time_duration_on_summary" => urlencode("Duração do tempo de exibição no resumo"),
      "reason" => urlencode("Razão"),
      "optional_label" => urlencode("Rótulo Opcional"),
      "optional_unit_symbol" => urlencode("Símbolo opcional da unidade"),
      "sqft" => urlencode("pés quadrados"),
      "min_limit" => urlencode("Meu limite"),
      "send_sms_to_staff" => urlencode("Envie SMS para o pessoal"),
      "staff_sms_template" => urlencode("Modelo de equipe SMS"),
      "preview_template" => urlencode("Modelo de pré-visualização"),
      "client__promocode" => urlencode("client_promocode"),
      "staff__email" => urlencode("staff_email"),
      "staff__name" => urlencode("staff_name"),
      "enable_or_disable_send_sms_to_staff_for_appointment_booking_info" => urlencode("Habilitar ou desabilitar, enviar SMS para a equipe para informações de reserva de compromisso"),


      "articles" => urlencode("Artigos"),
      "article_image" => urlencode("Imagem do artigo"),
      "booking_article" => urlencode("Artigo de reserva"),
      "article_name" => urlencode("Nome do artigo"),
      "article_rate" => urlencode("Taxa de Artigo"),
      "article_quantity" => urlencode("Quantidade de artigos"),
      "minimum_limit" => urlencode("Limite Mínimo"),
      "maximum_limit" => urlencode("Limite máximo"),
      "service_article" => urlencode("Artigo de serviço"),
      "minimum_delivery_days" => urlencode(" Prazo Mínimo de Entrega"),
      "advance_booking_days_limit" => urlencode(" Limite de dias de reserva antecipada"),
      "maximum_order_per_day" => urlencode("Ordem máxima por dia"),
      "show_self_service_option" => urlencode("Mostrar opção de autoatendimento"),
      "show_delivery_date" => urlencode("Mostrar data de entrega"),
    );
    ...
    $error_labels_pt_PT = array(
      ...
      "your_cart_is_empty_please_add_laundry_services" => urlencode("Seu carrinho está vazio, por favor, adicione serviços de limpeza"),
      ...
      "maximum_advance_booking_time_is_over" => urlencode("Максимальное время предварительного бронирования"),
      "appointment_booking_completed" => urlencode("Marcação de compromisso concluída"),
      "please_enter_hours" => urlencode("Por favor, insira horas"),
      "please_enter_minutes" => urlencode("Por favor, digite minutos"),
      "please_enter_minimum_5_minutes_maximum_59_minutes" => urlencode("Por favor, insira o mínimo de 5 minutos no máximo 59 minutos"),
      "invalid" => urlencode("Inválido"),
      "max_limit_reached" => urlencode("Limite Máximo Alcançado"),
      "please_enter_minlimit" => urlencode("Por favor insira minlimit"),
      "please_enter_value_greater_than_minlimit" => urlencode("Por favor insira um valor maior que minlimit"),
      "you_can_set_area_of_laundry_minimum_limit_" => urlencode("Você pode definir a área de limpeza do limite mínimo "),


      "please_select_pickup_date" => urlencode("Por favor selecione Pickup Date "),
      "please_select_pickup_slot" => urlencode("Por favor selecione Pickup Slot "),
      "please_select_delivery_date" => urlencode("Por favor selecione Data de Entrega "),
      "please_select_delivery_slot" => urlencode("Por favor selecione Delivery Slot "),
      "sorry_this_service_is_closed_now" => urlencode("Desculpe, este serviço está fechado agora "),
    );
    ...
    $insert_default_lang_pt_PT = "insert into `ld_languages` (`id`,`label_data`,`language`, `admin_labels`, `error_labels`, `extra_labels`, `front_error_labels`,`language_status`) values(NULL,'" . $language_front_arr_pt_PT . "','pt_PT','" . $language_admin_arr_pt_PT . "','" . $language_error_arr_pt_PT . "','" . $language_extra_arr_pt_PT . "','" . $language_form_error_arr_pt_PT . "','Y')";
    ...
    $label_data_ru_RU = array(
      ...
      "how_often_would_you_like_us_provide_service" => urlencode("Как часто вы хотели бы, чтобы мы оказывали услуги?"),
      ...
      "laundry_service" => urlencode("Уборка"),
      ...
      "do_you_have_a_vaccum_laundry" => urlencode("У вас есть пылесос?"),
      ...
      "recurring_discounts_apply_from_the_second_laundry_onward" => urlencode("Периодические скидки применяются после второй очистки."),
      ...
      "please_configure_first_laundry_services_and_settings_in_admin_panel" => urlencode("Сначала настройте службы очистки и настройки в панели администратора"),
      ...
      "your" => urlencode("Ваш"),
      "your_laundry_items" => urlencode("Ваши чистые предметы"),
      "cart_is_empty" => urlencode("Корзина пуста"),
      ...
      "carpet_laundry" => urlencode("Очистка ковров"),
      "green_laundry" => urlencode("Экологическая чистка"),
      "pets_care" => urlencode("Домашние животные"),
      "tiles_laundry" => urlencode("Очистка плитки"),
      "wall_laundry" => urlencode("Уборка стен"),
      "laundry" => urlencode("Прачечная"),
      "basement_laundry" => urlencode("Очистка подвала"),
      ...
      "for_initial_laundry_only_contact_us_to_apply_to_recurrings" => urlencode("Только для начальной очистки. Свяжитесь с нами, чтобы подать заявку на повтор."),
      ...
      "duration" => urlencode("продолжительность"),


      "select_pick_up_date_and_time" => urlencode("Выберите дату и время получения"),
      "select_delivery_date_and_time" => urlencode("Выберите дату и время доставки"),
      "self_service" => urlencode("Самообслуживание"),
      "when_would_you_like_us_to_pickup_and_deliver_your_clothes?" => urlencode("Когда вы хотите, чтобы мы забрали и доставили вашу одежду?"),
      "pickup" => urlencode("Подобрать"),
      "delivery" => urlencode("Доставка"),
      "select_articles" => urlencode("Выберите статьи"),
    );
    ...
    $admin_labels_ru_RU = array(
      ...
      "its_your_laundry_booking_form_page_url" => urlencode("его URL-адрес страницы формы бронирования Laundry"),
      "Its_your_laundry_Google_Settings_page_url" => urlencode("Его URL-адрес страницы настроек Google Laundry"),
      ...
      "add_laundry_service" => urlencode("Добавить уборку"),
      ...
      "send_mail" => urlencode("Отправить письмо"),
      "sender_email_address_laundry_admin_email" => urlencode("Электронная почта отправителя"),
      ...
      "vaccum_laundry" => urlencode("Пылесос"),
      ...
      "choose_your_article_image" => urlencode("Выберите изображение вашей статьи"),
      ...
      "vaccum_laundry_frontend_option_display_status" => urlencode("Пылесос"),
      "o_n" => urlencode("На"),
      "off" => urlencode("от"),
      ...
      "cart_items" => urlencode("Элементы корзины"),
      ...
      "vaccume_laundry" => urlencode("Пылесос"),
      ...
      "ld_special_offer" => urlencode("Специальное предложение"),
      "ld_special_offer_text" => urlencode("Текст специального предложения"),
      "appointment_rescheduled_by_service_provider" => urlencode("Назначение, перенесенное поставщиком услуг"),
      "rating_and_review" => urlencode("Рейтинг и обзор"),
      "review" => urlencode("обзор"),
      "show_frontend_staff_rating" => urlencode("Показать рейтинг персонала Frontend"),
      "with_enable_of_this_feature_shows_staff_rating_on_front_side" => urlencode("Включить эту функцию, Показывает рейтинг персонала на лицевой стороне"),
      "complete_appointment" => urlencode("Полное назначение"),
      "complete" => urlencode("полный"),
      "display_time_duration_on_summary" => urlencode("Отображение продолжительности времени в сводке"),
      "reason" => urlencode("причина"),
      "optional_label" => urlencode("Дополнительный ярлык"),
      "optional_unit_symbol" => urlencode("Дополнительный символ"),
      "sqft" => urlencode("кв. футы"),
      "min_limit" => urlencode("Мой предел"),
      "send_sms_to_staff" => urlencode("Отправить смс персоналу"),
      "staff_sms_template" => urlencode("Шаблон SMS для персонала"),
      "preview_template" => urlencode("Шаблон предварительного просмотра"),
      "client__promocode" => urlencode("client_promocode"),
      "staff__email" => urlencode("staff_email"),
      "staff__name" => urlencode("staff_name"),
      "enable_or_disable_send_sms_to_staff_for_appointment_booking_info" => urlencode("Включить или отключить, отправить SMS сотрудникам для информации о бронировании встречи"),


      "articles" => urlencode("статьи"),
      "article_image" => urlencode("Изображение статьи"),
      "booking_article" => urlencode("Бронирование статьи"),
      "article_name" => urlencode("Название статьи"),
      "article_rate" => urlencode("Оценить статью"),
      "article_quantity" => urlencode("Количество статей"),
      "minimum_limit" => urlencode("Минимальный предел"),
      "maximum_limit" => urlencode("Максимальный предел"),
      "service_article" => urlencode("Служебная статья"),
      "minimum_delivery_days" => urlencode(" Минимальные дни доставки"),
      "advance_booking_days_limit" => urlencode("Предварительное бронирование дней лимит"),
      "maximum_order_per_day" => urlencode("Максимальный заказ в день"),
      "show_self_service_option" => urlencode("Показать вариант самообслуживания"),
      "show_delivery_date" => urlencode("Показать дату доставки"),
    );
    ...
    $error_labels_ru_RU = array(
      ...
      "your_cart_is_empty_please_add_laundry_services" => urlencode("Ваша корзина пуста, пожалуйста, добавьте услуги по уборке"),
      ...
      "maximum_advance_booking_time_is_over" => urlencode("Максимальное время предварительного бронирования"),
      "appointment_booking_completed" => urlencode("Запланировано бронирование"),
      "please_enter_hours" => urlencode("Пожалуйста, введите часы"),
      "please_enter_minutes" => urlencode("Введите минуты"),
      "please_enter_minimum_5_minutes_maximum_59_minutes" => urlencode("Пожалуйста, введите минимум 5 минут максимум 59 минут"),
      "invalid" => urlencode("Недействительным"),
      "max_limit_reached" => urlencode("Максимальный предел достигнут"),
      "please_enter_minlimit" => urlencode("Пожалуйста, введите minlimit"),
      "please_enter_value_greater_than_minlimit" => urlencode("Пожалуйста, введите значение больше, чем minlimit"),
      "you_can_set_area_of_laundry_minimum_limit_" => urlencode("Вы можете установить область очистки минимального предела "),

      "please_select_pickup_date" => urlencode("Пожалуйста, выберите дату получения"),
      "please_select_pickup_slot" => urlencode("Пожалуйста, выберите Пикап Слот"),
      "please_select_delivery_date" => urlencode("Пожалуйста, выберите дату доставки"),
      "please_select_delivery_slot" => urlencode("Пожалуйста, выберите слот доставки"),
      "sorry_this_service_is_closed_now" => urlencode("Извините, этот сервис закрыт"),
    );
    ...
    $insert_default_lang_ru_RU = "insert into `ld_languages` (`id`,`label_data`,`language`, `admin_labels`, `error_labels`, `extra_labels`, `front_error_labels`,`language_status`) values(NULL,'" . $language_front_arr_ru_RU . "','ru_RU','" . $language_admin_arr_ru_RU . "','" . $language_error_arr_ru_RU . "','" . $language_extra_arr_ru_RU . "','" . $language_form_error_arr_ru_RU . "','Y')";
    ...
    $label_data_ar = array(
      ...
      "laundry_service" => urlencode("خدمة التنظيف"),
      ...
      "do_you_have_a_vaccum_laundry" => urlencode("هل لديك مكنسة كهربائية؟"),
      ...
      "recurring_discounts_apply_from_the_second_laundry_onward" => urlencode("تنطبق الخصومات المتكررة من التنظيف الثاني فصاعدًا."),
      ...
      "please_configure_first_laundry_services_and_settings_in_admin_panel" => urlencode("يرجى تكوين أول خدمات التنظيف والإعدادات في لوحة الإدارة"),
      ...
      "your" => urlencode("ك"),
      "your_laundry_items" => urlencode("العناصر النظيفة الخاصة بك"),
      "cart_is_empty" => urlencode("السلة فارغة"),
      "sub_totaltax" => urlencode("Sub TotalTax"),
      ...
      "carpet_laundry" => urlencode("تنظيف السجاد"),
      "green_laundry" => urlencode("تنظيف أخضر"),
      "pets_care" => urlencode("رعاية الحيوانات الأليفة"),
      "tiles_laundry" => urlencode("تنظيف البلاط"),
      "wall_laundry" => urlencode("تنظيف الجدار"),
      "laundry" => urlencode("غسيل ملابس"),
      "basement_laundry" => urlencode("تنظيف الطابق السفلي"),
      ...
      "for_initial_laundry_only_contact_us_to_apply_to_recurrings" => urlencode("للتنظيف الأولي فقط. اتصل بنا لتطبيق على التكرار."),
      ...
      "duration" => urlencode("المدة الزمنية"),


      "select_pick_up_date_and_time" => urlencode("حدد تاريخ ووقت الالتقاط"),
      "select_delivery_date_and_time" => urlencode("حدد تاريخ التسليم والوقت"),
      "self_service" => urlencode("خدمة ذاتية، إخدم نفسك بنفسك"),
      "when_would_you_like_us_to_pickup_and_deliver_your_clothes?" => urlencode("متى تريد منا التقاط وتسليم ملابسك؟"),
      "pickup" => urlencode("امسك"),
      "delivery" => urlencode("توصيل"),
      "select_articles" => urlencode("اختر المقالات"),
    );
    ...
    $admin_labels_ar = array(
      ...
      "its_your_laundry_booking_form_page_url" => urlencode("به صفحة نموذج حجز Laundry الحجز"),
      "Its_your_laundry_Google_Settings_page_url" => urlencode("في الصفحة الخاصة بك URL Laundry جوجل إعدادات"),
      ...
      "add_laundry_service" => urlencode("إضافة خدمة التنظيف"),
      ...
      "send_mail" => urlencode("ارسل بريد"),
      "sender_email_address_laundry_admin_email" => urlencode("البريد الإلكتروني المرسل"),
      ...
      "vaccum_laundry" => urlencode("فراغ منظف"),
      ...
      "choose_your_article_image" => urlencode("اختيار صورة مقالك"),
      ...
      "vaccum_laundry_frontend_option_display_status" => urlencode("مكنسة كهربائية"),
      "o_n" => urlencode("On"),
      "off" => urlencode("إيقاف"),
      ...
      "cart_items" => urlencode("عناصر السلة"),
      ...
      "vaccume_laundry" => urlencode("مكنسة كهربائية"),
      ...
      "ld_special_offer" => urlencode("عرض خاص"),
      "ld_special_offer_text" => urlencode("عرض خاص نص"),
      "appointment_rescheduled_by_service_provider" => urlencode("موعد جدولة من قبل مقدم الخدمة"),
      "rating_and_review" => urlencode("التقييم والمراجعة"),
      "review" => urlencode("إعادة النظر"),
      "show_frontend_staff_rating" => urlencode("إظهار تصنيف الموظفين المواجهين"),
      "with_enable_of_this_feature_shows_staff_rating_on_front_side" => urlencode("مع تمكين هذه الميزة ، يعرض تصنيف الموظفين على الجانب الأمامي"),
      "complete_appointment" => urlencode("الموعد الكامل"),
      "complete" => urlencode("اكتمال"),
      "display_time_duration_on_summary" => urlencode("مدة العرض في الملخص"),
      "reason" => urlencode("السبب"),
      "optional_label" => urlencode("تسمية اختيارية"),
      "optional_unit_symbol" => urlencode("رمز الوحدة الاختياري"),
      "sqft" => urlencode("قدم مربع."),
      "min_limit" => urlencode("الحد الخاص بي"),
      "send_sms_to_staff" => urlencode("إرسال الرسائل القصيرة للموظفين"),
      "staff_sms_template" => urlencode("قالب رسائل الموظفين"),
      "preview_template" => urlencode("معاينة القالب"),
      "client__promocode" => urlencode("client_promocode"),
      "staff__email" => urlencode("staff_email"),
      "staff__name" => urlencode("اسم الموظفين"),
      "enable_or_disable_send_sms_to_staff_for_appointment_booking_info" => urlencode("تمكين أو تعطيل ، إرسال الرسائل القصيرة للموظفين للحصول على معلومات الحجز الموعد"),


      "articles" => urlencode("مقالات"),
      "article_image" => urlencode("صورة المادة"),
      "booking_article" => urlencode("الحجز المادة"),
      "article_name" => urlencode("اسم المقال"),
      "article_rate" => urlencode("معدل المادة"),
      "article_quantity" => urlencode("المادة الكمية"),
      "minimum_limit" => urlencode("الحد الأدنى"),
      "maximum_limit" => urlencode("حد اقصي"),
      "service_article" => urlencode("المادة الخدمة"),
      "minimum_delivery_days" => urlencode(" أيام التسليم الحد الأدنى"),
      "advance_booking_days_limit" => urlencode(" أيام الحجز المسبق"),
      "maximum_order_per_day" => urlencode("الحد الأقصى للطلب في اليوم"),
      "show_self_service_option" => urlencode("ظهار خيار الخدمة الذاتية"),
      "show_delivery_date" => urlencode("عرض تاريخ التسليم"),
    );
    ...
    $error_labels_ar = array(
      ...
      "your_cart_is_empty_please_add_laundry_services" => urlencode("عربة التسوق فارغة ، يرجى إضافة خدمات التنظيف"),
      ...
      "maximum_advance_booking_time_is_over" => urlencode("الحد الأقصى للحجز مسبقا هو أكثر من اللازم"),
      "appointment_booking_completed" => urlencode("اكتمال حجز موعد"),
      "please_enter_hours" => urlencode("يرجى إدخال ساعات"),
      "please_enter_minutes" => urlencode("يرجى إدخال دقائق"),
      "please_enter_minimum_5_minutes_maximum_59_minutes" => urlencode("الرجاء إدخال الحد الأدنى لمدة 5 دقائق كحد أقصى 59 دقيقة"),
      "invalid" => urlencode("غير صالحة"),
      "max_limit_reached" => urlencode("أقصى حد تم الوصول إليه"),
      "please_enter_minlimit" => urlencode("الرجاء إدخال الحد الأدنى"),
      "please_enter_value_greater_than_minlimit" => urlencode("الرجاء إدخال قيمة أكبر من الحد الأدنى"),
      "you_can_set_area_of_laundry_minimum_limit_" => urlencode(" يمكنك تعيين مساحة الحد الأدنى للتنظيف"),

      "please_select_pickup_date" => urlencode("يرجى اختيار تاريخ الاستلام"),
      "please_select_pickup_slot" => urlencode("يرجى اختيار Pickup Slot "),
      "please_select_delivery_date" => urlencode("يرجى اختيار تاريخ التسليم "),
      "please_select_delivery_slot" => urlencode("يرجى اختيار فتحة التسليم"),
      "sorry_this_service_is_closed_now" => urlencode("عذرا ، هذه الخدمة مغلقة"),
    );
    ...
    $insert_default_lang_ar = "insert into `ld_languages` (`id`,`label_data`,`language`, `admin_labels`, `error_labels`, `extra_labels`, `front_error_labels`,`language_status`) values(NULL,'" . $language_front_arr_ar . "','ar','" . $language_admin_arr_ar . "','" . $language_error_arr_ar . "','" . $language_extra_arr_ar . "','" . $language_form_error_arr_ar . "','Y')";
    ...
    $label_data_zh_CN = array(
      ...
      "recurring_discounts_apply_from_the_second_laundry_onward" => urlencode("从第二次清洁开始，经常性折扣适用。"),
      ...
      "please_configure_first_laundry_services_and_settings_in_admin_panel" => urlencode("请在管理面板中配置第一个清洁服务和设置"),
      ...
      "your" => urlencode("你的"),
      "your_laundry_items" => urlencode("你干净的物品"),
      "cart_is_empty" => urlencode("购物车是空的"),
      "sub_totaltax" => urlencode("Sub TotalTax"),
      ...
      "carpet_laundry" => urlencode("地毯清洁"),
      "green_laundry" => urlencode("绿色清洁"),
      "pets_care" => urlencode("宠物护理"),
      "tiles_laundry" => urlencode("瓷砖清洁"),
      "wall_laundry" => urlencode("墙面清洁"),
      "laundry" => urlencode("洗衣店"),
      "basement_laundry" => urlencode("地下室清洁"),
      ...
      "for_initial_laundry_only_contact_us_to_apply_to_recurrings" => urlencode("仅适用于初次清洁。联系我们申请重复出现。"),
      ...
      "duration" => urlencode("持续时间"),

      "select_pick_up_date_and_time" => urlencode("选择接送日期和时间"),
      "select_delivery_date_and_time" => urlencode("选择交货日期和时间"),
      "self_service" => urlencode("自助服务"),
      "when_would_you_like_us_to_pickup_and_deliver_your_clothes?" => urlencode("您希望我们什么时候取货并送你的衣服？"),
      "pickup" => urlencode("拾起"),
      "delivery" => urlencode("交货"),
      "select_articles" => urlencode("选择文章"),
    );
    ...
    $admin_labels_zh_CN = array(
      ...
      "its_your_laundry_booking_form_page_url" => urlencode("它是您的洗衣预订表单页面网址"),
      "Its_your_laundry_Google_Settings_page_url" => urlencode("它是您的洗衣服务Google设置页面网址"),
      ...
      "add_laundry_service" => urlencode("添加清洁服务"),
      ...
      "addons_bookings" => urlencode("插件预订"),
      ...
      "sender_email_address_laundry_admin_email" => urlencode("发件人电子邮件"),
      ...
      "choose_your_article_image" => urlencode("选择您的文章图片"),
      ...
      "vaccum_laundry_frontend_option_display_status" => urlencode("吸尘器"),
      "o_n" => urlencode("上"),
      "off" => urlencode("离"),
      "enable" => urlencode("启用"),
      ...
      "ld_special_offer" => urlencode("特价"),
      "ld_special_offer_text" => urlencode("特价文字"),
      "appointment_rescheduled_by_service_provider" => urlencode("由服务提供商重新安排的预约"),
      "rating_and_review" => urlencode("评级和评论"),
      "review" => urlencode("评论"),
      "show_frontend_staff_rating" => urlencode("显示前端员工评级"),
      "with_enable_of_this_feature_shows_staff_rating_on_front_side" => urlencode("启用此功能后，在正面显示员工评级"),
      "complete_appointment" => urlencode("完成任命"),
      "complete" => urlencode("完成"),
      "display_time_duration_on_summary" => urlencode("显示汇总时间"),
      "reason" => urlencode("原因"),
      "optional_label" => urlencode("可选标签"),
      "optional_unit_symbol" => urlencode("可选单位符号"),
      "sqft" => urlencode("平方英尺"),
      "min_limit" => urlencode("我的极限"),
      "send_sms_to_staff" => urlencode("发送短信给员工"),
      "staff_sms_template" => urlencode("员工短信模板"),
      "preview_template" => urlencode("预览模板"),
      "client__promocode" => urlencode("客户端促销代码"),
      "staff__email" => urlencode("staff_email"),
      "staff__name" => urlencode("staff_name"),
      "enable_or_disable_send_sms_to_staff_for_appointment_booking_info" => urlencode("启用或禁用，向员工发送短信以获取预约信息"),


      "articles" => urlencode("用品"),
      "article_image" => urlencode("文章图片"),
      "booking_article" => urlencode("预订文章"),
      "article_name" => urlencode("文章名"),
      "article_rate" => urlencode("文章率"),
      "article_quantity" => urlencode("文章数量"),
      "minimum_limit" => urlencode("最低限额"),
      "maximum_limit" => urlencode("最高限额"),
      "service_article" => urlencode("服务文章"),
      "minimum_delivery_days" => urlencode(" 最短交货日"),
      "advance_booking_days_limit" => urlencode("提前预订天数限制"),
      "maximum_order_per_day" => urlencode("每日最高订单量"),
      "show_self_service_option" => urlencode("显示自助服务选项"),
      "show_delivery_date" => urlencode("显示交货日期"),
    );
    ...
    $error_labels_zh_CN = array(
      ...
      "your_cart_is_empty_please_add_laundry_services" => urlencode("您的购物车是空的请添加清洁服务"),
      ...
      "maximum_advance_booking_time_is_over" => urlencode("最长提前预订时间结束"),
      "appointment_booking_completed" => urlencode("预约完成预约"),
      "please_enter_hours" => urlencode("请输入营业时间"),
      "please_enter_minutes" => urlencode("请输入分钟"),
      "please_enter_minimum_5_minutes_maximum_59_minutes" => urlencode("请输入最少5分钟最多59分钟"),
      "invalid" => urlencode("无效"),
      "max_limit_reached" => urlencode("达到最大限度"),
      "please_enter_minlimit" => urlencode("请输入最低限额"),
      "please_enter_value_greater_than_minlimit" => urlencode("请输入大于最小限度的值"),
      "you_can_set_area_of_laundry_minimum_limit_" => urlencode("您可以设置清洁最低限度区域 "),


      "please_select_pickup_date" => urlencode("请选择提货日期 "),
      "please_select_pickup_slot" => urlencode("请选择皮卡槽 "),
      "please_select_delivery_date" => urlencode("请选择交货日期"),
      "please_select_delivery_slot" => urlencode("请选择Delivery Slot"),
      "sorry_this_service_is_closed_now" => urlencode("对不起，这项服务现已关闭 "),
    );
    ...
    $insert_default_lang_zh_CN = "insert into `ld_languages` (`id`,`label_data`,`language`, `admin_labels`, `error_labels`, `extra_labels`, `front_error_labels`,`language_status`) values(NULL,'" . $language_front_arr_zh_CN . "','zh_CN','" . $language_admin_arr_zh_CN . "','" . $language_error_arr_zh_CN . "','" . $language_extra_arr_zh_CN . "','" . $language_form_error_arr_zh_CN . "','Y')";
    mysqli_query($this->conn, $insert_default_lang_zh_CN);
  }
  public function q26()
  {
    $update_sender_email = "UPDATE `ld_settings` SET `option_value` = '" . $this->email . "' WHERE `option_name` = 'ld_email_sender_address';";
  ...
  public function q34()
  {
  $query_staff_payment = "CREATE TABLE `ld_staff_commission` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `order_id` int(11) NOT NULL,
...
public function q36()
  {
    $email_template = "CREATE TABLE IF NOT EXISTS `ld_email_templates` (
		  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `ld_email_templates` (`id`, `email_subject`, `email_message`, `default_message`, `email_template_status`, `email_template_type`, `user_type`) VALUES
(1, 'Appointment Request', '', '', 'E', 'A', 'C'),
(2, 'New Appointment Request Requires Approval', '', '', 'E', 'A', 'A'),
(3, 'New Appointment Assigned', '', '', 'E', 'A', 'S'),
(4, 'Appointment Approved', '', '', 'E', 'C', 'C'),
(5, 'Appointment Approved', '', '', 'E', 'C', 'A'),
(6, 'Appointment Approved', '', '', 'E', 'C', 'S'),
(7, 'Appointment Rejected', '', '', 'E', 'R', 'C'),
(8, 'Appointment Rejected', '', '', 'E', 'R', 'A'),
(9, 'Appointment Rejected', '', '', 'E', 'R', 'S'),
(10, 'Appointment Cancelled by you', '', '', 'E', 'CC', 'C'),
(11, 'Appointment Cancelled By Customer', '', '', 'E', 'CC', 'A'),
(12, 'Appointment Cancelled By Customer', '', '', 'E', 'CC', 'S'),
(13, 'Appointment Rescheduled by you', '', '', 'E', 'RS', 'C'),
(14, 'Appointment Rescheduled By Customer', '', '', 'E', 'RS', 'A'),
(15, 'Appointment Rescheduled By Customer', '', '', 'E', 'RS', 'S'),
(16, 'Client Appointment Reminder', '', '', 'E', 'RM', 'C'),
(17, 'Admin Appointment Reminder', '', '', 'E', 'RM', 'A'),
(18, 'Admin Appointment Reminder', '', '', 'E', 'RM', 'S');";
        mysqli_query($this->conn,$email_template_insert);
 
    

    $sms_template = "CREATE TABLE IF NOT EXISTS `ld_sms_templates` (
		  `id` int(11) NOT NULL AUTO_INCREMENT,
		  ...
		  `sms_template_type` enum('A','C','R','CC','RS','RM','CS') COLLATE utf8_unicode_ci NOT NULL COMMENT 'A=active, C=confirm, R=Reject, CC=Cancel by Client,CS=Cancel by Staff, RS=Reschedule, RM=Reminder',
		  `user_type` enum('A','C','S') COLLATE utf8_unicode_ci NOT NULL COMMENT 'A=Admin,C=client,S=Staff',
		  PRIMARY KEY (`id`)
		) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=30 ;";
     ...
     $sms_template_insert = "
     INSERT INTO `ld_sms_templates` (`id`, `sms_subject`, `sms_message`, `default_message`, `sms_template_status`, `sms_template_type`, `user_type`) VALUES
...
(3, 'New Appointment Request Requires Approval', '', 'RGVhciB7e3N0YWZmX25hbWV9fSwKWW91IGhhdmUgYW4gYXBwb2ludG1lbnQgb24ge3tib29raW5nX2RhdGV9fSBmb3Ige3tzZXJ2aWNlX25hbWV9fQ===', 'E', 'A', 'S'),
(4, 'Appointment Approved', '', 'RGVhciB7e2NsaWVudF9uYW1lfX0sDQpZb3VyIGFwcG9pbnRtZW50IG9uIHt7Ym9va2luZ19kYXRlfX0gZm9yIHt7c2VydmljZV9uYW1lfX0gaGFzIGJlZW4gY29uZmlybWVkLg', 'E', 'C', 'C'),
(5, 'Appointment Approved', '', 'RGVhciB7e2FkbWluX25hbWV9fSwNCllvdXIgYXBwb2ludG1lbnQgd2l0aCB7e2NsaWVudF9uYW1lfX0gb24ge3tib29raW5nX2RhdGV9fSBmb3Ige3tzZXJ2aWNlX25hbWV9fSBoYXMgYmVlbiBjb25maXJtZWQu', 'E', 'C', 'A'),
(6, 'Appointment Approved', '', 'RGVhciB7e3N0YWZmX25hbWV9fSwKWW91ciBhcHBvaW50bWVudCB3aXRoIHt7Y2xpZW50X25hbWV9fSBvbiB7e2Jvb2tpbmdfZGF0ZX19IGZvciB7e3NlcnZpY2VfbmFtZX19IGhhcyBiZWVuIGNvbmZpcm1lZC4=', 'E', 'C', 'S'),
(7, 'Appointment Rejected', '', 'RGVhciB7e2NsaWVudF9uYW1lfX0sDQpZb3VyIGFwcG9pbnRtZW50IG9uIHt7Ym9va2luZ19kYXRlfX0gZm9yIHt7c2VydmljZV9uYW1lfX0gaGFzIGJlZW4gcmVqZWN0ZWQu', 'E', 'R', 'C'),
(8, 'Appointment Rejected', '', 'RGVhciB7e2FkbWluX25hbWV9fSwNCllvdXIgYXBwb2ludG1lbnQgd2l0aCB7e2NsaWVudF9uYW1lfX0gb24ge3tib29raW5nX2RhdGV9fSBmb3Ige3tzZXJ2aWNlX25hbWV9fSBoYXMgYmVlbiByZWplY3RlZC4=', 'E', 'R', 'A'),
(9, 'Appointment Rejected', '', 'RGVhciB7e3N0YWZmX25hbWV9fSwKWW91ciBhcHBvaW50bWVudCB3aXRoIHt7Y2xpZW50X25hbWV9fSBvbiB7e2Jvb2tpbmdfZGF0ZX19IGZvciB7e3NlcnZpY2VfbmFtZX19IGhhcyBiZWVuIHJlamVjdGVkLg==', 'E', 'R', 'S'),
(10, 'Appointment Cancelled by you', '', 'RGVhciB7e2NsaWVudF9uYW1lfX0sDQpZb3VyIGFwcG9pbnRtZW50IG9uIHt7Ym9va2luZ19kYXRlfX0gZm9yIHt7c2VydmljZV9uYW1lfX0gaGFzIGJlZW4gY2FuY2VsbGVkLg==', 'E', 'CC', 'C'),
(11, 'Appointment Cancelled By Customer', '', 'RGVhciB7e2FkbWluX25hbWV9fSwNCllvdXIgYXBwb2ludG1lbnQgd2l0aCB7e2NsaWVudF9uYW1lfX0gb24ge3tib29raW5nX2RhdGV9fSBmb3Ige3tzZXJ2aWNlX25hbWV9fSBoYXMgYmVlbiBjYW5jZWxsZWQu', 'E', 'CC', 'A'),
(12, 'Appointment Cancelled By Customer', '', 'RGVhciB7e3N0YWZmX25hbWV9fSwKWW91ciBhcHBvaW50bWVudCB3aXRoIHt7Y2xpZW50X25hbWV9fSBvbiB7e2Jvb2tpbmdfZGF0ZX19IGZvciB7e3NlcnZpY2VfbmFtZX19IGhhcyBiZWVuIGNhbmNlbGxlZC4=', 'E', 'CC', 'S'),
(13, 'Appointment Rescheduled by you', '', 'RGVhciB7e2NsaWVudF9uYW1lfX0sDQpZb3VyIGFwcG9pbnRtZW50IG9uIHt7Ym9va2luZ19kYXRlfX0gZm9yIHt7c2VydmljZV9uYW1lfX0gaGFzIGJlZW4gcmVzY2hlZHVsZWQu', 'E', 'RS', 'C'),
(14, 'Appointment Rescheduled By Customer', '', 'RGVhciB7e2FkbWluX25hbWV9fSwNCllvdXIgYXBwb2ludG1lbnQgd2l0aCB7e2NsaWVudF9uYW1lfX0gb24ge3tib29raW5nX2RhdGV9fSBmb3Ige3tzZXJ2aWNlX25hbWV9fSBoYXMgYmVlbiByZXNjaGVkdWxlZC4=', 'E', 'RS', 'A'),
(15, 'Appointment Rescheduled By Staff', '', 'RGVhciB7e3N0YWZmX25hbWV9fSwKWW91ciBhcHBvaW50bWVudCB3aXRoIHt7Y2xpZW50X25hbWV9fSBvbiB7e2Jvb2tpbmdfZGF0ZX19IGZvciB7e3NlcnZpY2VfbmFtZX19IGhhcyBiZWVuIHJlc2NoZWR1bGVkLg==', 'E', 'RS', 'S'),
(16, 'Client Appointment Reminder', '', 'RGVhciB7e2NsaWVudF9uYW1lfX0sCllvdXIgYXBwb2ludG1lbnQgd2l0aCB7e2FkbWluX25hbWV9fSBpcyBzY2hlZHVsZWQgaW4ge3thcHBfcmVtYWluX3RpbWV9fSBob3Vycy4=', 'E', 'RM', 'C'),
(17, 'Admin Appointment Reminder', '', 'RGVhciB7e2FkbWluX25hbWV9fSwKWW91ciBhcHBvaW50bWVudCB3aXRoIHt7Y2xpZW50X25hbWV9fSBpcyBzY2hlZHVsZWQgaW4ge3thcHBfcmVtYWluX3RpbWV9fSBob3Vycy4=', 'E', 'RM', 'A'),
(18, 'Staff Appointment Reminder', '', 'RGVhciB7e3N0YWZmX25hbWV9fSwKWW91ciBhcHBvaW50bWVudCB3aXRoIHt7Y2xpZW50X25hbWV9fSBpcyBzY2hlZHVsZWQgaW4ge3thcHBfcmVtYWluX3RpbWV9fSBob3Vycy4=', 'E', 'RM', 'S');";
  ...
  public function q30()
  {
    $query = "CREATE TABLE IF NOT EXISTS `ld_staff_status` (
  ...
  public function q31()
  {
    $query = "CREATE TABLE IF NOT EXISTS `ld_rating_review` (
    		  `id` int(11) NOT NULL AUTO_INCREMENT,
          `staff_id` int(11) NOT NULL,
  ...
  public function q32()
  {
    $query = "CREATE TABLE IF NOT EXISTS `ld_otp` (
		  `id` int(11) NOT NULL AUTO_INCREMENT,
