							...
							<div class="tab-content">
								<form id="reset_new_passwd" method="post">
									...
									if($current_time > $url_time){	?>
										<label style="display:block;color:'red';"><?php echo filter_var($label_language_values['your_reset_password_link_expired']);	?></label>
									<div class="clearfix"> 
										<a href="javascript:void(0)" class="btn ld-reset-btn btn-lg ld-xs-12 col-xs-12"><?php echo filter_var($label_language_values['reset_password']);	?></a>
									</div>
									<?php 
										}else{
									?>
