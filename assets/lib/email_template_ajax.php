<?php 
	...
	if(isset($_POST['save_email_template'])){
		$email_template->id = filter_var($_POST['id']);
		$email_template->email_message = base64_encode(filter_var($_POST['email_message']));
		$updated = $email_template->update_email_template();
	}
	else if(isset($_POST['save_email_template_status'])){
		$email_template->id = filter_var($_POST['id']);
		$email_template->email_template_status = filter_var($_POST['email_template_status']);
